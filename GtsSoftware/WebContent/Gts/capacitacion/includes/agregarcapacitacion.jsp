...
function alt_submit(){
	if(confirm("¿Seguro que desea agregar una nueva Capacitación?"))
	{
			  ...
			  <div class="row-fluid sortable">
			    <div class="box span12">
			      <div class="box-header well" data-original-title>
			        <h2><i class=" icon-screenshot"></i> AGREGAR CAPACITACIÓN</h2>
					</div>
					<div class="box-content">
					
						<form class="form-horizontal" id="frmProceso" name="frmProceso" method="POST" action="<%= response.encodeURL("SMVPersonal")%>">
			                <input type="hidden" name="accion" value="AgregarCapacitacion"></input>
							<input type="hidden" name="tipo" value="2"></input>
							
						  <fieldset>                                                                              
							  
							  <div class="control-group">                        
                                  <label class="control-label" for="typeahead1">Nombre de Capacitación: </label>
                                  <div class="controls">
		 					...
		 					<div class="control-group">
							  ...
							  <div class="control-group" id="dvFechaI">
				            	...
				            	<div class="controls">
				             		 <input type="text" class="input-small datepicker" id="fechaInicio" name="fechaInicio" maxlength="10" required>		           		
				            	</div>
			            	  </div>
			            	  <div class="control-group" id="dvFechaII">
		            			<label class="control-label" for="typeahead4">Fecha Fin: </label>
		            		 
				            	<div class="controls">
				             		 <input type="text" class="input-small datepicker" id="fechaFin" name="fechaFin" maxlength="10" required>		           		
				            	</div>
			            	  </div>                        	
                             <div class="control-group">  
			            ...
			            <div class="form-actions">
			              ...
			              AGREGAR</button>
			              <button type="reset" class="btn" onclick="location.href='buscarcapacitacion.jsp'">
