			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-search"></i>  BUSCAR CAPACITACIÓN		  </h2>						
						<div  align="right">
                               <a class="btn btn-primary" href="/GtsSoftware/Gts/capacitacion/agregarcapacitacion.jsp"> <i class="icon icon-add icon-white"></i> CREAR CAPACITACIÓN </a> 
					...
					<div class="box-content">
						<form class="form-horizontal" name="frmCriteriosBusqueda" id="frmCriteriosBusqueda"  method="POST" action="<%= response.encodeURL("SMVPersonal")%>">
						  ...
						  <fieldset>
						    ...
						    <br>
						    <div class="control-group">
							    <label class="control-label" for="typeahead6">ID Capacitación : </label>
							    <div class="controls">
