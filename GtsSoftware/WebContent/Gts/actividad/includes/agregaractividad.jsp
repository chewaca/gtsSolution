			  ...
			  <div class="row-fluid sortable">
			    <div class="box span12">
			      <div class="box-header well" data-original-title>
			        <h2><i class="icon-list"></i> AGREGAR ACTIVIDAD</h2>
					</div>
					<div class="box-content">
					
						<form class="form-horizontal" id="frmActividad" name="frmActividad" method="POST" action="<%= response.encodeURL("SMVActividad")%>">
			            ...
			            <div class="form-actions">
			              ...
			              AGREGAR</button>
			              <button type="reset" class="btn" onclick="location.href='buscaractividad.jsp'">
