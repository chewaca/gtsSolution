						...
						<form class="form-horizontal" id="frmProceso" name="frmProceso" method="POST" action="<%= response.encodeURL("SMVPersonal")%>">
						  ...
						  <fieldset>                                                                              
                         	...
                         	<div class="control-group">                        
                                  ...
                                  <div class="controls">
                                  	<input type="text"  class="span4 typeahead" id="txtApPaterno" name="txtApPaterno" data-provide="typeahead" >
                                  </div>
                              </div>
							<div class="control-group">                        
                                  <label class="control-label" for="typeahead1">Ap. Materno: </label>
                                  <div class="controls">
                                  	<input type="text"  class="span4 typeahead" id="txtApMaterno" name="txtApMaterno" data-provide="typeahead" >
                                  </div>
                              </div>
                              <div class="control-group">                        
                                  <label class="control-label" for="typeahead1">DNI: </label>
                                  <div class="controls">
                                  	<input type="text"  class="span2 typeahead" id="txtDNI" name="txtDNI"  data-provide="typeahead" maxlength="8" onkeypress="return isNumberKey(event)" >
                                  </div>
                              </div>
                              <div class="control-group">
							 ...
							 <div class="control-group" id="dvFechaI">
				            	...
				            	<div class="controls">
				             		 <input type="text" class="input-small datepicker" id="fcNacimiento" name="fcNacimiento" readonly="readonly" maxlength="10">		           		
				            	</div>
			            	  </div>
                              <div class="control-group">                        
                                  <label class="control-label" for="typeahead1">Correo: </label>
                                  <div class="controls">
                                  	<input type="text"  class="span4 typeahead" id="txtCorreo" name="txtCorreo" data-provide="typeahead" >
                                  </div>
                              </div>
                              <div class="control-group">                        
                                  <label class="control-label" for="typeahead1">Telefono 1: </label>
                                  <div class="controls">
                                  	<input type="text"  class="span2 typeahead" id="txtTelefono1" name="txtTelefono1"  data-provide="typeahead" maxlength="12" onkeypress="return isNumberKey(event)" >
                                  </div>
                              </div>
                              <div class="control-group">                        
                                  <label class="control-label" for="typeahead1">Telefono 2: </label>
                                  <div class="controls">
                                  	<input type="text"  class="span2 typeahead" id="txtTelefono2" name="txtTelefono2"  data-provide="typeahead" maxlength="12" onkeypress="return isNumberKey(event)" >
                                  </div>
                              </div>
