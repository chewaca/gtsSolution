...
<script>
	...
	function alt_seleccionar(cod,nombre){
		parent.anhadirRolEjecutor(cod,nombre);
	}
	</script>	
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-search"></i> BUSCAR ROL EJECUTOR</h2>						                     
				  </div>
                            ...
                            <td class="center"  onclick="javascript:alt_consultar(<%=((ResultadoRolData)resultados.get(i)).getCodigo()%>)">
                          	        ...
                          	        <td class="center">
                          				...
                          				<a class="btn btn-primary"
                          					href="javascript:alt_seleccionar('<%=((ResultadoRolData)resultados.get(i)).getCodigo()%>','<%=((ResultadoRolData)resultados.get(i)).getNombre()%>')">
                          					<i
