<!-- AGREGAR SUBPROCESO DESDE PROCESO -->
...
<head>
	...
	-->
	<meta charset="utf-8">
	<title>Sistema GTS - Proceso</title>
			  ...
			  <div class="row-fluid sortable">
			    <div class="box span12">
			      <div class="box-header well" data-original-title>
			        <h2>AGREGAR SUBPROCESO</h2>
					</div>
					<div class="box-content">
					
						<form class="form-horizontal" id="frmSubproceso" name="frmSubproceso" method="POST" action="<%= response.encodeURL(request.getContextPath()+"/Gts/proceso/SMVProceso")%>">
			                <input type="hidden" name="accion" value="AgregarSubproceso"></input>
